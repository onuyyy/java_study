 ...
 * 	1) 문자를 자르기 : substring()
 * 	2) 문자를 분리하기 : split()
 *  3) 문자를 변경하기 : replace(), replaceAll()
 *  4) 모든 데이터형을 문자로 변경하기 : valueOf()
 * 
 */
public class 문자열_5 {
...
//		String n = "That That (Prod. & Feat. SUGA of BTS)";
...
//		}
		...
		String addr = "전라북도 전주시 완산구 공북로 82"+
				"지번 전라북도 전주시 완산구 태평동 10-9";
		
		String addr2 = addr.substring(0,19);
		System.out.println(addr2);
		
		System.out.println("=============================");
		
		String ss = addr.substring(0,addr.lastIndexOf("지번"));	// lastIndexOf " " => " " 앞에서 끊어라
		System.out.println(ss);
		...
		// a 값 찾기 ( a 두 개중 무엇? ) => indexOf 앞에서부터 a를 찾아냄 / lastIndexOf 뒤에서부터 a를 찾아냄
		
		String qq = addr.substring(0,addr.indexOf("완"));		// 82 앞까지 끊어서 출력
		...
		String str3 = str.replace("Java", "Oracle");
