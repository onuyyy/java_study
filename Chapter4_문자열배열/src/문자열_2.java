...
//		
//		for(String s:title) {
//			if(s.startsWith(fd)) {			// title 배열 안에 fd 입력값으로 시작하는 값을 가져와라
//				System.out.println(s);
////				try {
////					Thread.sleep(500);		// 잠깐 멈췄다가 출력하라
////				} catch(Exception ex) {}
//			}
//		}
//		
